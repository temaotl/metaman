                ...
                <dl>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 px-4 py-5">
                        ...
                        <dd class="sm:col-span-2">
                            ...
                            <input
                                class="text-sm dark:bg-transparent @error('xml_id') border-red-500 border @else @if (old('xml_id') !== null) border-green-500 @endif @enderror focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm border-gray-300 dark:border-gray-700 rounded-md"
                    ...
                    <div class="dark:bg-gray-800 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 px-4 py-5 bg-white">
                        ...
                        <dd class="sm:col-span-2">
                            ...
                            <input
                                class="text-sm dark:bg-transparent @error('xml_name') border-red-500 border @else @if (old('xml_name') !== null) border-green-500 @endif @enderror focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm border-gray-300 dark:border-gray-700 rounded-md"
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 px-4 py-5">
                        ...
                        <dd class="sm:col-span-2">
                            ...
                            <input
                                class="text-sm dark:bg-transparent @error('filters') border-red-500 border @else @if (old('filters') !== null) border-green-500 @endif @enderror focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm border-gray-300 dark:border-gray-700 rounded-md"
