<div class="mb-4">
    ...
    <a @class([
        ...
        'bg-blue-100 hover:bg-blue-300' => !request()->routeIs('federations.operators'),
    ...
    <a @class([
        ...
        'bg-blue-100 hover:bg-blue-300' => !request()->routeIs('federations.entities'),
    ...
    @can('update', $federation)
        <a @class([
            ...
            'bg-blue-100 hover:bg-blue-300' => !request()->routeIs('federations.requests'),
