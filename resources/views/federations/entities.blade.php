                ...
                <div class="bg-white border rounded-lg overflow-x-auto">
                    ...
                    @if (count($members))
                        <div class="px-4 py-2 bg-gray-100">
                            <x-buttons.submit color="red" text="{{ __('common.delete_members') }}" target="delete_members"/>
        ...
        <div>
            ...
            <form id="add_members" action="{{ route('federations.update', $federation) }}" method="post">
                ...
                <div class="bg-white border rounded-lg overflow-x-auto">
                    ...
                    @if (count($entities))
                        <div class="px-4 py-2 bg-gray-100">
                            <x-buttons.submit color="blue" text="{{ __('common.add_members') }}" target="add_members"/>
