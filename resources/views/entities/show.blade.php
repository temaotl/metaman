...
@section('content')
    ...
    <div class="dark:bg-gray-800 sm:rounded-lg mb-6 overflow-hidden bg-white shadow">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-900 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 px-4 py-5">
                            ...
                            <dd class="sm:col-span-2">
                                <form class="inline-block" action="{{ route('entities.update', $entity) }}" method="post">
                                    ...
                                    <button class="hover:bg-gray-200 px-4 py-2 text-gray-600 bg-gray-300 rounded shadow" type="reset">{{ __('common.reset') }}</button>
        ...
        <div class="px-6 py-3 bg-gray-100">
            ...
            <a class="hover:bg-blue-700 text-blue-50 inline-block px-4 py-2 bg-blue-600 rounded shadow" href="{{ route('entities.metadata', $entity) }}">{{ __('entities.get_metadata') }}</a>
            <a class="hover:bg-blue-700 text-blue-50 inline-block px-4 py-2 bg-blue-600 rounded shadow" href="{{ route('entities.showmetadata', $entity) }}" target="_blank">{{ __('entities.show_metadata') }}</a>

            @can('update', $entity)
                @unless ($entity->trashed())
                    <a class="hover:bg-yellow-200 inline-block px-4 py-2 text-yellow-600 bg-yellow-300 rounded shadow" href="{{ route('entities.edit', $entity) }}">{{ __('common.edit') }}</a>
                @endunless
            @endcan
