    ...
    <form action="{{ route('categories.update', $category) }}" method="post">
        ...
        <div class="mb-6 bg-white sm:rounded-lg shadow overflow-hidden">
                ...
                <dl>
                    <div class="px-4 py-5 bg-gray-50 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="sm:col-span-2">
                            ...
                            <input class="text-sm dark:bg-transparent @error('name') border-red-500 border @else @if(old('name') !== null) border-green-500 @endif @enderror focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm border-gray-300 dark:border-gray-700 rounded-md" type="text" name="name" id="name" maxlength="32" placeholder="{{ __('categories.name_placeholder') }}" value="{{ $category->name }}" required>
                        </dd>
                    </div>
                    <div class="px-4 py-5 bg-white dark:bg-gray-800 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        ...
                        <dd class="sm:col-span-2">
                            ...
                            <input class="text-sm dark:bg-transparent @error('description') border-red-500 border @else @if(old('description') !== null) border-green-500 @endif @enderror focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm border-gray-300 dark:border-gray-700 rounded-md" type="text" name="description" id="description" maxlength="255" placeholder="{{ __('categories.description_placeholder') }}" value="{{ $category->description }}" required>
                        </dd>
                    </div>    
                    <div class="px-4 py-5 bg-gray-50 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                        <dt class="text-sm text-gray-500">
            ...
            <div class="px-4 py-4 bg-gray-100">
                ...
                <x-buttons.submit text="{{ __('categories.update') }}"/>
            </div>
    </form>
